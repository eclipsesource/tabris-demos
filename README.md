...
This repository contains a single Eclipse project that is used within the [Tabris Screencasts](http://developer.eclipsesource.com/tabris/demos/). The steps to get this running are described at [docs/1.4](http://developer.eclipsesource.com/tabris/docs/1.4/getting-started/samples/). After running this project the following Entrypoints are available:
